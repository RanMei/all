...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "D:\\git\\all\\hot\\src\\_test\\Counter.vue";
	if (typeof __vue_options__.name === "undefined") {
	  __vue_options__.name = "Counter";
	...
	if (false) {
	  (function () {
	    ...
	    module.hot.accept();
	    if (!module.hot.data) {
	      hotAPI.createRecord("data-v-c79e8766", __vue_options__);
	    } else {
	      hotAPI.reload("data-v-c79e8766", __vue_options__);
	    }
	  })();
	}
	if (__vue_options__.functional && typeof __vue_template__ !== "undefined") {
	  console.error("[vue-loader] Counter.vue: functional components are not supported with templates, they should use render functions.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-c79e8766", module.exports)
	  }
	}
