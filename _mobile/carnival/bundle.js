...
window.initSNS = function () {
	...
	$.ajax({ "url": "http://event.book.qq.com/andmain/sum?act_f=160714&act_b=index", type: "GET", success: function success() {} });
	...
	$('.btn').on('touchend', function (e) {
		...
		if (ok) {
			...
			$.ajax({ "url": "http://event.book.qq.com/andmain/sum?act_f=160714&act_b=click", type: "GET", success: function success() {} });
	...
	$('.confirm').on('touchend', function () {
		...
		$.ajax({ "url": "http://event.book.qq.com/andmain/sum?act_f=160714&act_b=down", type: "GET", success: function success() {} });
		//下载QQ阅读APP。
