	...
	function Home(props) {
		...
		_this.state = {
			list: [{
				...
				title: 'interactive',
				hrefs: ['./_mobile/svg/gooey_menu.html', './_mobile/svg/stack.html']
			}, {
				title: 'SVG',
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ href: './_mobile/svg/button-blobs.html' },
					...
					React.createElement(
						'a',
						{ href: './_mobile/svg/stroke-square.html' },
						'./_mobile/svg/stroke-square.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/svg/stroke-circle.html' },
						'./_mobile/svg/stroke-circle.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/svg/stroke-jar.html' },
						'./_mobile/svg/stroke-jar.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/svg/stroke-gameboy.html' },
					...
					React.createElement(
						'a',
						{ href: './_mobile/h5/star_wars/index.html' },
						'./_mobile/h5/star_wars/index.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/h5/olympics/index.html' },
					...
					React.createElement(
						'a',
						{ href: './_mobile/h5/carnival/index.html' },
						'./_mobile/h5/carnival/index.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/h5/school/index.html' },
						'./_mobile/h5/school/index.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/h5/feast/feast.html' },
						'./_mobile/h5/feast/feast.html'
					),
					React.createElement('br', null),
					React.createElement(
						'a',
						{ href: './_mobile/h5/project/index.html' },
