window.addEventListener('DOMContentLoaded',function(){
	...
	function start(){
		...
		var W = canvas.width = config.canvas_width;
		var H = canvas.height = config.canvas_height;	
		...
		function FlameParticle(){
			...
			var locmin = (W/2)-(config.flamewidth/2); 
			var locmax = (W/2)+(config.flamewidth/2);
			this.location = {
			...
			//life range = 20-30
			this.life = config.flame_base_life + Math.random()*10;
			this.remaining_life = this.life;
			//colors
			this.r = config.flame_r;
