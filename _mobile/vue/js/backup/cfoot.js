...
var _CONF={
		...
		LOCAL_HOST_NAME: 'http://solomotest4.3g.qq.com/book_res/event/actc1/', //本地开发访问地址
	    DEVELOP_SERVER:	 'http://test3.wapmusic.qq.com/iosmain/', 	//开发环境后台服务地址

		TEST_HOST_NAME:		'solomotest4.3g.qq.com',				//测试环境访问地址
		TEST_LOCAL_HOST:'http://solomotest4.3g.qq.com/book_res/event/actc1/', //测试环境访问地址
		TEST_SERVER:	'http://test3.wapmusic.qq.com/iosmain/',	//测试环境后台服务地址
		
		FORMAL_HOST_NAME:	'iyuedu.qq.com',					//正式环境访问地址
		FORMAL_LOCAL_HOST:'http://iyuedu.qq.com/event/actc1/', //正式环境页面地址
