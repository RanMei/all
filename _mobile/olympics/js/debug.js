(function(){
	...
	mask.style.cssText += 
		'position:fixed; left:0; top:0; width:100%; height:50%; padding:20px; overflow:scroll; background:black; opacity:0.8; z-index:9999; color:white; font-size: 16px; display:none;';
