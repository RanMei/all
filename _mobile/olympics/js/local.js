...
var Local = (function( JsBridge,common ){
    ...
    Local.resApis = function () {
        JsBridge.restoreApis({
            'JSContent': ['setStatInfo', 'openExternal', 'openDetail', 'closeDialog', 'openMonthly', 'setWebTitlebarIcon', 'openTopicComment'],
     ...
     * @param from
     */
    Local.openVIPFrom = function(from) {
        Local.forceLog( param("act_f"), from );
        Local.openVip(true);
    }
