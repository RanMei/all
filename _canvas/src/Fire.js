...
FlameParticle.prototype = {
	spawn: function(){
		...
		//life range = 20-30
		this.life = this.cv.flame_base_life + Math.random()*10;
		this.remaining_life = this.life;
		//colors
		this.r = this.cv.flame_r;
...
var Fire = Canvas.extend({
	...
	methods: {
		createParticles: function(){
			...
			for(var o = 0; o < this.smoke_count; o++){
		...
		addControl: function(){
			...
			panel.style.cssText += 'position:fixed;right:0;top:0;';
			document.querySelector('body').appendChild(panel);
			['particle_count','smoke_count','flame_base_life','flame_r','flamewidth'].forEach(function(a){
